...
1. 最新のexeリリースを[こちら](https://github.com/beetron/QuinAutoRun/releases/download/v.1.0/QuinAutoRun-v1.0b.zip)からダウンロードします。<br>
...
5. プログラム起動後、ゲーム内で`マウスミドルボタン`を使用してオートランをオン/オフします。
...
1. Download latest exe release from [here](https://github.com/beetron/QuinAutoRun/releases/download/v.1.0b/QuinAutoRun-v1.0b.zip)<br>
...
4. Launch program again.  Use the `Middle Mouse Button` while in-game to toggle auto-run ON/OFF.
